...
# AWS Grading Script (Without CloudFront)
...
# Task 1: EC2 and Launch Template
echo "[Task 1: EC2 + Launch Template]" | tee -a grading_report.txt
...
# Task 2: ALB and ASG
echo "[Task 2: ALB + ASG]" | tee -a grading_report.txt
...
# Task 3: S3 Website Hosting
echo "[Task 3: S3 Static Website]" | tee -a grading_report.txt
